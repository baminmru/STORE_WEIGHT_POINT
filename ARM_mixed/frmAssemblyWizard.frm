...
Attribute GetWeight4.VB_HelpID = 120
  On Error Resume Next
    Dim ws As String
    Dim ch As String
    Dim start As Single
...
'отображение кнопок визарда в нужной позиции
...
Dim result As Boolean
  ...
  If MyRound(txt4Netto) <= 0 Then
    ...
    Exit Function
  End If
  If MyRound(txt3FullWeight) + MyRound(txt4Netto) > 1200 Then
    MsgBox "Суммарный вес превышает 1200 кг."
    After2 = False
    Exit Function
  End If
End Function
