...
Attribute VB_HelpID = 405
Option Explicit
'форма фильтра - журнал паллеты

Public Item As Object
Attribute Item.VB_VarHelpID = 420
'изменено
Public OK As Boolean
Attribute OK.VB_VarHelpID = 425
Private OnInit As Boolean
Public Event Changed()
Attribute Changed.VB_HelpID = 410
