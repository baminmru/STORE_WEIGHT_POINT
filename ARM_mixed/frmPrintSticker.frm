...
Attribute VB_HelpID = 665

Option Explicit
' параметры для печати стикера

'изменено
Public OK As Boolean
Attribute OK.VB_VarHelpID = 670
Public poddon As ITTPL.ITTPL_DEF
Attribute poddon.VB_VarHelpID = 675
...
' возврат выбранного поддона через переменную poddon
...
' перенос фокуса для поддержки сканера штрихкодов
