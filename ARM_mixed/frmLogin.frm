...
Attribute OK.VB_VarHelpID = 565

' получить текущего пользователя windows
'Parameters:
' параметров нет
'Returns:
'  значение типа String - имя пользователя
'See Also:
'  OK
'Example:
...
Attribute GetUser.VB_HelpID = 560
...
'загрузка списка сайтов из файла конфигурации
