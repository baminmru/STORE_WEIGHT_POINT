...
' вычисление строки баркода
'Parameters:
'[IN][OUT]  chaine , тип параметра: String  - строка
'Returns:
'  значение типа String - значение строки баркода
'Example:
' dim variable as String
' variable = me.code128(...параметры...)
Public Function code128(chaine As String) As String
Attribute code128.VB_HelpID = 15
