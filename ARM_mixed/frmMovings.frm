...
Attribute VB_HelpID = 590
Option Explicit
'Окно ввода результатов оптимизации

Public movetask As ITTOPT.Application
Attribute movetask.VB_VarHelpID = 595
...
'проверка и сохранение результатов ввода
...
'запуск доп. логики при смене состояния
...
Private Function RegisterMove(ByRef MD As ITTOPT_MOVE) As Boolean
  ...
  If MD.ISMoved = Boolean_Net And Len(MD.ThePalletteNum) = 6 Then
    ...
    If Not rs.EOF Then
      ...
      ")VALUES( " & _
      "getdate(),3,'" & itemrs!code & "','" & itemrs!Description & "','" & strs!LOT_SN & "'," & MakeMSSQLDate(strs!exp_date) & "," & strs!Unit_COST & "," & MyRound2(strs!QTY_ON_HAND) & ",-" & MyRound2(strs!QTY_ON_HAND) & ",'" & strs!UOM & "','Наличие'," & _
      ...
      "CUSTOM_FIELD9, CUSTOM_FIELD10, CUSTOM_FIELD11, CUSTOM_FIELD12, CUSTOM_FIELD13, CUSTOM_FIELD14, CUSTOM_FIELD15, CUSTOM_FIELD16 " & _
      ")VALUES( " & _
      "getdate(),4,'" & itemrs!code & "','" & itemrs!Description & "','" & strs!LOT_SN & "'," & MakeMSSQLDate(strs!exp_date) & "," & strs!Unit_COST & "," & 0 & "," & MyRound2(strs!QTY_ON_HAND) & ",'" & strs!UOM & "','Наличие'," & _
